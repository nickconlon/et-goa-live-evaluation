...
class StateObject:
    ...
    def get_state_array(self):
        return [*self.pos, *self.ori, len(self.obs), self.robot_time, self.wall_time]

    def set_state(
        self, position, orientation, sensed_obs, t_robot, t_wall, goal, waypoint
    ):
...
def do_rollout(
    position, orientation, goal, waypoint_counter, known_obstacles, waypoints=None
):
    d = {
    ...
    print(yaml.dump(d))
    fname = (
        r"C:/Users/nick/Documents/CODE/webots/et-goa/controllers/rollout_controller/"
    )
