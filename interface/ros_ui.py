...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stop_robot = QtWidgets.QPushButton(self.centralwidget)
        self.stop_robot.setGeometry(QtCore.QRect(150, 260, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.stop_robot.setFont(font)
        self.stop_robot.setObjectName("stop_robot")
        self.start_robot = QtWidgets.QPushButton(self.centralwidget)
        self.start_robot.setGeometry(QtCore.QRect(20, 260, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.start_robot.setFont(font)
        self.start_robot.setObjectName("start_robot")
        self.process_et_data = QtWidgets.QPushButton(self.centralwidget)
        self.process_et_data.setGeometry(QtCore.QRect(20, 410, 201, 51))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.process_et_data.setFont(font)
        self.process_et_data.setObjectName("process_et_data")
        ...
        self.write_data.setGeometry(QtCore.QRect(230, 410, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.end_sim.setGeometry(QtCore.QRect(370, 410, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.run_goa.raise_()
        self.stop_robot.raise_()
        self.start_robot.raise_()
        self.process_et_data.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stop_robot.setText(_translate("MainWindow", "Stop"))
        self.start_robot.setText(_translate("MainWindow", "Auto drive"))
        self.process_et_data.setText(_translate("MainWindow", "Process ET data"))
        ...
        self.write_data.setText(_translate("MainWindow", "Write data"))
        ...
        self.confidence_panel_label.setText(_translate("MainWindow", "Machine Self-Confience Assessments"))
        self.confidence_panel_label_2.setText(_translate("MainWindow", "Robot Control"))
